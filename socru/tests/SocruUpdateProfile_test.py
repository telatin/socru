...
class TestSocruUpdateProfile(unittest.TestCase):
    ...
    def test_socru_lookup(self):
        ...
        s = SocruUpdateProfile(Options(os.path.join(data_dir, 'yersinia'),os.path.join(data_dir, 'profile.txt'), 'output_profile.txt'))
        s.run()
    ...
    def test_same_update_twice(self):
        ...
        s = SocruUpdateProfile(Options(os.path.join(data_dir, 'yersinia'),os.path.join(data_dir, 'profile_full.txt'), 'output_profile.txt'))
        s.run()
